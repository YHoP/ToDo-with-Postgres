...
SELECT pg_catalog.setval('categories_tasks_id_seq', 4, true);
...
COPY tasks (id, description, iscompleted, duedate) FROM stdin;
3	get milk	t	2015-09-25
2	wash the car	f	2015-10-03
\.
